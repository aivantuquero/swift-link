...
export default function Jumbotron() {
  return (
    <div className="bg-white relative flex items-center justify-center overflow-hidden  z-50 h-screen">
      <div className="relative mx-auto flex items-center h-full px-4  pb-20   md:pb-10 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8">
        <div className="flex flex-col items-center justify-between lg:flex-row py-16">
          <div className=" relative ">
            ...
            <div className="lg:max-w-xl lg:pr-5 relative z-40">
              ...
              <h2 className="mb-6 max-w-lg text-5xl font-light leading-snug tracking-tight text-g1 sm:text-7xl sm:leading-snug">
                Top-tier URL Reduction
                <span className="my-1 inline-block border-b-8 border-g4 border-purple-900 bg-white px-4 font-bold text-g4 animate__animated animate__flash">
                  Period.
                </span>
              </h2>
              <p className="text-base text-gray-700">
                Secure Your Online Experience with SwiftLink. Your Trusted
                Partner in Efficient Link Shortening.
              </p>
              <div className="mt-10 flex flex-col items-center md:flex-row">
                <a
                  href="/"
                  className="mb-3 inline-flex h-12 w-full items-center justify-center rounded bg-purple-500 px-6 font-medium tracking-wide text-white shadow-md transition hover:bg-purple-800 focus:outline-none md:mr-4 md:mb-0 md:w-auto"
                >
                  View More
                </a>
                <a
          ...
          <div className="relative hidden lg:ml-32 lg:block lg:w-1/2">
            ...
            <div className="abg-orange-400 mx-auto w-fit overflow-hidden rounded-[6rem] rounded-br-none rounded-tl-none z-50">
              <Image
                src="/jumbotron_hero.svg"
                alt="Jumbotron Hero"
                width={500}
                height={500}
              />
      ...
      <div className=" absolute -bottom-0 left-3/4 z-0  opacity-10 ">
        <svg
          ...
          viewBox="0 0 256 256"
          xmlns="http://www.w3.org/2000/svg"
          className="w-48 z-0  h-full -rotate-90   object-fill fill-purple-400 text-purple-300"
        >
          <path
